        ...
        switch (tag) {
          ...
          case 26: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              columns_ = new java.util.ArrayList<com.google.area120.tables.v1alpha1.ColumnDescription>();
              mutable_bitField0_ |= 0x00000001;
            }
            columns_.add(
                input.readMessage(com.google.area120.tables.v1alpha1.ColumnDescription.parser(), extensionRegistry));
            break;
          }
          default: {
